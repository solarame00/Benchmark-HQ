            ...
            <Card>
                <CardHeader>
                    <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                        ...
                        {renderFilterDropdown(selectedMarketsForScore, handleMarketFilterChangeForScore, 'Filter by Market...')}
                    </div>
                </CardHeader>
                <CardContent className="space-y-4">
                     <RankingTable 
                        ...
                        valueKey="score"
                        valueLabel="Score"
                        onRowClick={(benchmark) => setViewingBenchmark(benchmark)}
                     />
                     {topByScore.length > 5 && (
            ...
            <Card>
                <CardHeader>
                     <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                        ...
                        {renderFilterDropdown(selectedMarketsForTraffic, handleMarketFilterChangeForTraffic, 'Filter by Market...')}
                    </div>
                </CardHeader>
                <CardContent className="space-y-4">
                     <RankingTable 
